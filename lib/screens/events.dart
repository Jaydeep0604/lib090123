...
class _EventsState extends State<Events> {
  ...
  @override
  void initState() {
    eventController.getEventList(context,0,10);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarDetails(appBar: AppBar(), text: 'EVENT'),
      // appBar: AppBar(
      //   leading: Container(
                        ...
                        ? ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          "${eventController.eventList[index].eventName}",
                                          style: TextStyle(
                                              color: AppColor.white,
                             ...
                             data:"${eventController.eventList[index].eventDetail.toString()}"),
                                        // Text(
                                        //   "${eventController.eventList[index].eventDetail}",
                                        //   style: TextStyle(
                                        //       color: AppColor.white,
                                        //       fontSize: 11),
                                        //   maxLines: 3,
