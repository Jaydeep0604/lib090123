...
class _GroupSubscriptionState extends State<GroupSubscription> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarDetails(appBar: AppBar(), text: 'GROUP SUBSCRIPTION'),
      // appBar: AppBar(
      //   leading: Container(
                      ...
                      GestureDetector(
                        onTap: () {
                          ...
                          setState(() {
                            ...
                            if ( isValidState && selectedValue != null && groupSubscriptionController.phoneNumberController.text.isNotEmpty) {
